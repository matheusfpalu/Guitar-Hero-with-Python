...
class Game:
    ...
    def run(self):
        ...
        # Obtenha a duração da música em milissegundos
...
class MusicMenu:
    ...
    def __init__(self):
        ...
        self.music1 = Button((0, 255, 0), SCREEN_WIDTH//2 - self.button_width//2, SCREEN_HEIGHT//3 - self.button_height//2, self.button_width, self.button_height, 'You Only Live Once')
        self.music2 = Button((0, 255, 0), SCREEN_WIDTH//2 - self.button_width//2, SCREEN_HEIGHT//2 - self.button_height//2, self.button_width, self.button_height, 'Dani California')
        self.music3 = Button((0, 255, 0), SCREEN_WIDTH//2 - self.button_width//2, SCREEN_HEIGHT*2//3 - self.button_height//2, self.button_width, self.button_height, 'Everlong')
